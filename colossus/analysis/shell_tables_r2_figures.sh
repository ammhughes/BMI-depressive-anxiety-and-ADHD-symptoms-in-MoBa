...
#SBATCH --job-name=shell_tables_r2_figures
#
#Project:
#SBATCH --account=p471
#
...
#To run this script: sbatch scripts/shell_tables_r2_figures.sh
...
#define the program
MYEX="stata-mp do scripts/tables_r2_figures.do ${1}"
#MYEX="stata-mp do scripts/tables_r2_figures.do"
