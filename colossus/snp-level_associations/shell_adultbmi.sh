...
#SBATCH --job-name=shell_adultbmi
#
#Project:
...
#To run this script: sbatch /cluster/p/p471/cluster/projects/mh_bmi/fullsample/snp-level_associations/scripts/shell_adultbmi.sh
...
#define the program
MYEX="stata-mp do scripts/innermost_adultbmi.do ${1}"
#MYEX="stata-mp do scripts/innermost_adultbmi.do snp"
