...
import delimited "data\genetic\noclump_full_pgs_childbmi\full_pgs_childbmi.all_score", delimiter(space, collapse) clear
save "data\genetic\noclump_full_pgs_childbmi\full_pgs_childbmi.all_score.dta", replace

*import delimited "data\genetic\full_gwas_pgs\full_pgs_childbmi.all_score", delimiter(space, collapse) clear
*save "data\genetic\full_pgs_childbmi.all_score.dta", replace

*like the other PGS, need to reshape via the covariate file.
use "data\genetic\noclump_full_pgs_childbmi\full_pgs_childbmi.all_score.dta", clear
*use "data\genetic\full_pgs_childbmi.all_score.dta", clear
...
rename fid c_fid
rename iid c_iid 
rename pt_1 c_full_pgs_childbmi
rename pt_5e08 c_full_pgs_childbmi_5e08
save "scratch/c_full_pgs_childbmi.dta", replace
restore
...
rename fid m_fid
rename iid m_iid 
rename pt_1 m_full_pgs_childbmi
rename pt_5e08 m_full_pgs_childbmi_5e08
save "scratch/m_full_pgs_childbmi.dta", replace
restore
...
rename pt_1 f_full_pgs_childbmi
rename pt_5e08 f_full_pgs_childbmi_5e08
save "scratch/f_full_pgs_childbmi.dta", replace
restore
...
count
*112,198
merge 1:m PREG_ID_2306 using "scratch/c_full_pgs_childbmi.dta"
rename _merge _merge1
*N increased here because of multiple births, presumably (1:m merge)
count
*112,949
merge m:1 M_ID_2306 using "scratch/m_full_pgs_childbmi.dta"
...
merge m:1 F_ID_2306 using "scratch/f_full_pgs_childbmi.dta"
...
foreach var in c_full_pgs_childbmi m_full_pgs_childbmi f_full_pgs_childbmi c_full_pgs_childbmi_5e08 m_full_pgs_childbmi_5e08 f_full_pgs_childbmi_5e08 {
	egen z_`var'=std(`var')
	summ z_`var'
}

save "scratch/reshaped_linkable_full_pgs_childbmi.dta", replace
