...
head  ${OUTM}/clumped_moba_adultbmi_snplist.txt
wc -l ${OUTM}/clumped_moba_adultbmi_snplist.txt
#961
...
plink2 --bfile ${INM}/projects/moba_interim_release_post_imp_qc/qcd_genetic_data_Feb22/merge.no_batch.noX.geno.mind.hwe \
	--extract ${OUTM}/clumped_moba_adultbmi_snplist.txt \
	--export A \
	--out ${OUTM}/adultbmi_snps
